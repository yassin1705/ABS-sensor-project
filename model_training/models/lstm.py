"""LSTM multivariee pour la prediction des quatre vitesses ECU."""
...
class LSTMForecaster(BaseWheelSpeedForecaster):
    """Encode l'historique par une LSTM puis predit tout l'horizon."""
